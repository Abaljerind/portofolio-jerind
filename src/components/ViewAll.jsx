...
export default function ViewAll() {
  return (
    ...
    >
      <button className="flex scale-90 cursor-pointer items-center justify-between rounded-lg border-2 border-[#EBEBEB] bg-white p-2.5 dark:border-none dark:bg-[#373737]">
