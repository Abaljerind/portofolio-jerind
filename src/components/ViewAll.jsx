...
export default function ViewAll() {
  return (
    ...
    >
      <button className="flex w-fit scale-90 cursor-pointer items-center justify-between rounded-lg border-2 border-[#EBEBEB] bg-white p-2.5 md:text-lg dark:border-none dark:bg-[#373737]">
