    ...
    <>
      ...
      <div className="profile flex flex-col px-6">
        ...
        <p className="mb-10 text-justify text-[16px] leading-7 tracking-tight text-[#666666] dark:text-[#C0C0C0]">
          ...
          the gap between design and functionality, ensuring that users have a
        ...
        <p className="mb-5 text-justify text-[16px] leading-7 tracking-tight text-[#666666] dark:text-[#C0C0C0]">
          ...
          practices. He continuously expands his skills through online courses,
          hands-on projects, and continuous learning. His experience includes
        ...
        <p className="mb-10 text-justify text-[16px] leading-7 tracking-tight text-[#666666] dark:text-[#C0C0C0]">
          ...
          maintaining a healthy work-life balance, ensuring he takes breaks to
          recharge and stay motivated. As part of his routine, he dedicates his
          weekends to regular exercise, which helps improve focus, reduce
          stress, and maintain overall well-being—allowing him to stay sharp and
          energized for new challenges in web development.
        </p>
      </div>
